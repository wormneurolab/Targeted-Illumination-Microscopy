...
NeedImageEnhancement = 0; % 1: Use neuron fiber enhancement filter, 0: Original widefield
...
if AlignMode == 1
    ImageUpLimitForShow = 5000; 
    CaptureIt = 1; 
    LEDIntensity = 5; % 0-100 linear representation
...
if NeedImageEnhancement == 0
    ...
    while ishandle(h)
        ...
        set(h, 'CData', ImageBuf); % Update image data beneath drawn crosshairs
